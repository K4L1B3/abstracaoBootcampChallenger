...
I abstracted the digital innovation One website and created a kind of program in which it has the function of:

- [X] Register Devs
- [X] register Devs in bootcamps
- [X] Show completed bootcamps
- [X] Show the XP
